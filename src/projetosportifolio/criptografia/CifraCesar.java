package projetosportifolio.criptografia;
...
public class CifraCesar {
    public static void main(){
        ...
        do{
            op = Leitura.lerInteiro("Menu - Cifra de Cesar\n\n1. Codificar texto\n2. Decodificar texto\n3. Sair\n\n> ");

            if(op == 1 || op == 2){
                txt = Leitura.lerString("Insira seu texto: ");
                if(Objects.equals(txt, ".") || Objects.equals(txt, "debug")){
                    txt = Leitura.lerString("[DEBUG]: Insira novamente seu texto: ");
                    debug = true;
                }
                key = Leitura.lerInteiro("Insira sua chave (de 0 á 25): ");
            }
